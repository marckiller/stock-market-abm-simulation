...
class EventOrderCanceled(Event):

    type = EventType.ORDER_CANCELED
    executable = False
    ...
    def create_message(self):
        return super().create_message() + f"Order {self.order_id} {self.ticker} canceled for agent {self.agent_id}."